...
class TwoLayerNet(object):
    ...
    def __init__(
        ...
        # Initialize weights and biases of the first layer
        self.params['W1'] = weight_scale * np.random.randn(input_dim, hidden_dim)
        self.params['b1'] = np.zeros(hidden_dim)

        # Initialize weights and biases of the second layer
    ...
    def loss(self, X, y=None):
        ...
        # Calculate data loss using softmax
...
class FullyConnectedNet(object):
    ...
    def loss(self, X, y=None):
        ...
        scores, cache[f'ch{self.num_layers}a'] = affine_forward(out_i, self.params[f'W{self.num_layers}'], self.params[f'b{self.num_layers}'])
